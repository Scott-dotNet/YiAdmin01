...
namespace YiAdmin01.BLL.Business
{
    public class DepartmentBLL
    {
        ...
        /// <summary>
        /// 获取用户和部门列表，并将其转换为 ZtreeInfo 对象列表
        /// </summary>
        /// <param name="param"></param>
        /// <returns></returns>
